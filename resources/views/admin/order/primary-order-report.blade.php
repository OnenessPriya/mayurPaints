                        ...
                        <div class="col-auto">
                            ...
                            <select class="form-control form-control-sm" id="distributor" name="distributor">
                                ...
                                @foreach ($allDistributors as $item)
                                    <option value="{{$item->distributor_name}}" {{ (request()->input('distributor') == $item->distributor_name) ? 'selected' : '' }}>{{$item->distributor_name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-auto">
