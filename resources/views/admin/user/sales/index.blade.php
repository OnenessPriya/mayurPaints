                ...
                <div class="card-body">
                    <div class="search__filter">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('admin.user.sales-person.create') }}" class="btn btn-outline-danger btn-sm">
                                    Create 
                                </a>
                            </div>
                            <div class="col-auto">
                            <a href="{{ route('admin.user.sales-person.export.all',['term'=>$request->term]) }}"  class="btn btn-outline-danger btn-sm float-right"><i class="fa fa-cloud-download"></i> CSV Export</a>
                            </div>
                        </div>
                    </div>
