                ...
                <div class="card-body">
                    ...
                    <div class="search__filter">
                        <div class="row align-items-center justify-content-between">
                            <div class="col">
                                <ul>
                                    <li class="active"><a href="{{ route('admin.qrcode.index') }}">All <span class="count">({{$data->count()}})</span></a></li>
                                    @php
                                    ...
                                    @endphp
                                    <li><a href="{{ route('admin.qrcode.index', ['status' => 'active'])}}">Active <span class="count">({{$activeCount}})</span></a></li>
                                    <li><a href="{{ route('admin.qrcode.index', ['status' => 'inactive'])}}">Inactive <span class="count">({{$inactiveCount}})</span></a></li>
                                </ul>
                            </div>
                            <div class="col-auto">
                    ...
                    <form action="{{ route('admin.qrcode.bulkDestroy') }}">
                        <div class="filter">
                            <div class="row align-items-center justify-content-between">
                            <div class="col">
                                <div class="row g-3 align-items-center">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->type == 1 ? $item->points. '' : ''.$item->points}}</td>
                                    <td>
                                        @php
                                            $couponsCount = \DB::table('q_r_codes')->where('slug', $item->slug)->count();
                                        @endphp
                                        <div class="btn-group">
                                            <a href="{{ route('admin.qrcode.view', $item->slug) }}" class="btn btn-sm btn-primary">{{$couponsCount}}</a>
                                            {{-- <a id="basic" class="btn btn-sm btn-warning">Export generated qrcodes</a> --}}
                                        </div>
                                    </td>
