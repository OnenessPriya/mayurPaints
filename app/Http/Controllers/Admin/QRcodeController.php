...
class QRcodeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($storeData) {
            return redirect()->route('admin.qrcode.index')->with('success', 'New qrcode created');
        } else {
            return redirect()->route('admin.qrcode.create')->withInput($request->all())->with('success', 'Something happened');
        }
    }
